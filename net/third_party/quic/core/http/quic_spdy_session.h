...
class QUIC_EXPORT_PRIVATE QuicSpdySession : public QuicSession {
 ...
 protected:
  ...
  QuicSpdyStream* GetSpdyDataStream(const QuicStreamId stream_id, bool unreliable);
 ...
 private:
  ...
  void OnPriority(spdy::SpdyStreamId stream_id, spdy::SpdyPriority priority, bool unreliable);
