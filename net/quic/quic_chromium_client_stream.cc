...
void QuicChromiumClientStream::OnInitialHeadersComplete(
    ...
    size_t frame_len,
    const quic::QuicHeaderList& header_list) {
  quic::QuicSpdyStream::OnInitialHeadersComplete(fin, unreliable, frame_len, header_list);
...
void QuicChromiumClientStream::OnTrailingHeadersComplete(
    ...
    size_t frame_len,
    const quic::QuicHeaderList& header_list) {
  quic::QuicSpdyStream::OnTrailingHeadersComplete(fin, unreliable, frame_len, header_list);
